...
async function getRainfallmm() {
  const res = await fetch(
    'https://api.thingspeak.com/channels/2531448/fields/2.json?api_key=UFR2I5V9Z9KMQ10X'
  );
...
const Rainfallmm = async () => {
  const data = (await getRainfallmm()) as WeighingRainGaugeMM;

  return (
    <div className="flex flex-col bg-gray-950 rounded-xl">
      <div className="p-4 flex flex-col gap-2">
        <h1 className=" opacity-70 font-extrabold">RAINFALL IN MM</h1>
