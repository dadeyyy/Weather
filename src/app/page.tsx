  ...
  return (
    ...
    >
      <link
        ...
        sizes="<generated>"
      />
      <main className="container mx-auto backdrop-blur-md bg-slate-800 rounded-2xl opacity-80  text-white flex flex-col sm:flex-row p-9 gap-10 sm:h-auto h-full justify-center items-center max-w-4xl">
        <RecentData/>
